 ...
 * )
 */
class ActivityTincan extends FieldableEntity {
  /**
   * The module handler.
   *
  ...
  public function prepareRow(Row $row) {
    ...
    $fid = $connection->select('opigno_tincan_question_type_question_properties', 'o_t_p')
      ->fields('o_t_p', ['fid'])
      ->condition('nid', $nid)
      ->execute()
      ->fetchField();
    ...
    $row->setSourceProperty('opigno_tincan_package', $attributes);
