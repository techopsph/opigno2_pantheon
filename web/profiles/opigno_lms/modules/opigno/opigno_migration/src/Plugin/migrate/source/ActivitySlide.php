 ...
 * )
 */
class ActivitySlide extends FieldableEntity {
  /**
   * The module handler.
   *
  ...
  public function prepareRow(Row $row) {
    ...
    $fid = $connection->select('field_data_slide_pdf', 'd_s_p')
      ->fields('d_s_p', ['slide_pdf_fid'])
      ->condition('entity_id', $nid)
      ->condition('bundle', 'quiz_directions')
      ->execute()
      ->fetchField();
    ...
    if (!empty($file)) {
      ...
      $row->setSourceProperty('opigno_slide_pdf', $attributes);
    }
