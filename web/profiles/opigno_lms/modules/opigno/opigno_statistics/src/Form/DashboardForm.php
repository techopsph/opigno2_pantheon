...
class DashboardForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if ($moduleHandler->moduleExists('opigno_skills_system')) {
      $form['content_statistics']['skills_list'] = $this->buildSkillsTable();
    }

    $form['content_statistics']['trainings_list'] = $this->buildTrainingsList($lp_ids);
