...
/**
 * Provides a 'ActivityFileUpload' migrate source.
 *
 * @MigrateSource(
 ...
 * )
 */
class ActivityFileUpload extends FieldableEntity {
  /**
   * The module handler.
   *
  ...
  public function query() {
    ...
    $query->innerJoin('field_revision_body', 'b', 'b.revision_id = nr.vid');
    $query->innerJoin('quiz_fileupload_node_properties', 'qp', 'qp.vid = nr.vid');
