 ...
 * )
 */
class ActivityScorm extends FieldableEntity {
  /**
   * The module handler.
   *
  ...
  public function prepareRow(Row $row) {
    ...
    $fid = $connection->select('field_data_opigno_scorm_package', 'o_s_p')
      ->fields('o_s_p', ['opigno_scorm_package_fid'])
    ...
    $row->setSourceProperty('opigno_scorm_package', $attributes);
